 ...
 * {@link SellerProfileFragment.OnFragmentInteractionListener} interface
...
public class SellerProfileFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSellerProfileFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onSellerProfileFragmentInteraction(Uri uri);
    }
}
